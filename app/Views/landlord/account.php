...
<head>
    ...
    <title>Cài đặt tài khoản - RoomFinder.vn</title>
    ...
    <div class="landlord-container">
        ...
        <aside class="landlord-sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="/landlord/account" class="menu-item active">
        ...
        <main class="landlord-main">
            ...
            <div class="dashboard-section">
                <div style="padding: 60px 20px; text-align: center; color: #6b7280;">
                    <i class="fas fa-user" style="font-size: 48px; opacity: 0.5; display: block; margin-bottom: 16px;"></i>
                    <h3 style="margin: 0; font-size: 16px; color: #4b5563;">Trang cài đặt tài khoản sẽ được cập nhật</h3>
                </div>
            </div>
        </main>
    </div>
